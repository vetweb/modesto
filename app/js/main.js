...
/* harmony import */ var _functions_page_loaded__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/page-loaded */ "./src/js/functions/page-loaded.js");
...
(0,_functions_page_loaded__WEBPACK_IMPORTED_MODULE_0__.pageLoaded)();
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_1__.validateForms)('.js-form', rules1, afterForm, disableScroll);
...
/***/ "./src/js/functions/page-loaded.js":
/*!*****************************************!*\
  !*** ./src/js/functions/page-loaded.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _disable_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./disable-scroll */ "./src/js/functions/disable-scroll.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modal */ "./src/js/functions/modal.js");
/* harmony import */ var _enable_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./enable-scroll */ "./src/js/functions/enable-scroll.js");
...
const validateForms = (selector, rules, afterSend) => {
  ...
  for (let item of rules) {
    validation.addField(item.ruleSelector, item.rules, item.errorMessage);
  }
  validation.onSuccess(ev => {
    (0,_modal__WEBPACK_IMPORTED_MODULE_3__.modalOpen)();
    (0,_disable_scroll__WEBPACK_IMPORTED_MODULE_2__.disableScroll)();
    window.setTimeout(function () {
      (0,_modal__WEBPACK_IMPORTED_MODULE_3__.modalCLose)();
      (0,_enable_scroll__WEBPACK_IMPORTED_MODULE_4__.enableScroll)();
    }, 1500);
  });
};
